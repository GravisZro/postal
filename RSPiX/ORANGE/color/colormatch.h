...
public:
  ...
  ~RAlpha();
  //==========================================================
  channel_t* m_pAlphas[256]; // array of 256 ptrs to uint8_t lists
  ...
  int16_t CreateLightEffectRGB(channel_t* pa,
                               channel_t* pr,
                               channel_t* pg,
                               channel_t* pb,
  ...
  int16_t CreateLightEffectRGB(int16_t sPalStart=0,
                               int16_t sPalLen = palette::size);
  ...
  void FinishEffect(int16_t sPalStart = 0,
                    int16_t sPalLen = palette::size); // will create it for you.
  ...
  static channel_t ms_r[palette::size];
  static channel_t ms_g[palette::size];
  static channel_t ms_b[palette::size];
  static channel_t ms_a[palette::size];
  static channel_t ms_f[palette::size];
...
public:
  ...
  static channel_t ms_red  [palette::size];
  static channel_t ms_green[palette::size];
  static channel_t ms_blue [palette::size];
};
...
public:
  ...
  channel_t* m_pLevelOpacity; // for each layer
  // This goes from a 0-255 Alpha channel DIRECTLY to an alpha matrix
  channel_t** m_pGeneralAlpha[palette::size];
  ...
  uint8_t m_pSaveLevels[palette::size];
